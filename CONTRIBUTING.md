# Contributing to paymenthub-ee-connector-mm-gsma

Thank you for your interest in contributing to the paymenthub-ee-connector-mm-gsma! We welcome contributions from the community to help improve financial inclusion solutions globally.
...
- Have a look at our [Wiki](https://github.com/openMF/paymenthub-ee-connector-mm-gsma/wiki).
...
- Fork the [project](https://github.com/openMF/paymenthub-ee-connector-mm-gsma) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/paymenthub-ee-connector-mm-gsma.git
```
...
```bash
git remote add upstream https://github.com/openMF/paymenthub-ee-connector-mm-gsma.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/paymenthub-ee-connector-mm-gsma.git (fetch)
  > origin    https://github.com/your-username/paymenthub-ee-connector-mm-gsma.git (push)
  > upstream  https://github.com/openMF/paymenthub-ee-connector-mm-gsma.git (fetch)
  > upstream  https://github.com/openMF/paymenthub-ee-connector-mm-gsma.git (push)
```
